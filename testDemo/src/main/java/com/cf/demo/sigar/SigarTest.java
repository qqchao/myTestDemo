...
public class SigarTest {
	//public static final Logger logger = Logger.getLogger(SigarTest.class);     
	public static void main(String[] args) {  
		...
		public static void cpuRate() throws SigarException{
            ...
            for (int i = 0; i < cpuList.length; i++) {// 不管是单块CPU还是多CPU都适用  
	            ...
	            double cpuRateCombined = cpuList[i].getCombined();
	            cpuRate += cpuRateCombined;
            }
            DecimalFormat df=new DecimalFormat("#.##"); 
            System.out.println(df.format(100 * cpuRate / cpuList.length)+"%");
		}
